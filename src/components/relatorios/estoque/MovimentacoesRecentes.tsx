...
import { formatDate, formatCurrency, getTipoIcon, getTipoLabel, formatTipoColor } from "./utils";

export function MovimentacoesRecentes({ movimentacoes }: { movimentacoes: MovimentacaoResumo[] }) {
  return (
